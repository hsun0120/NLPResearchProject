...
public class hashJoin {
  ...
  public void doublePipelinedHashJoin(String dict, String doc, String out) {
    ...
    try {
      this.writer = new PrintWriter(new OutputStreamWriter(new FileOutputStream(out), FMT));
